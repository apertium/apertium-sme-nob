...
(MT) system from Northern S\'{a}mi to Norwegian Bokm{\aa}l, re-using
...
with about 4.5 million speakers, mostly in Norway. Northern S\'{a}mi
...
forms to the lexicon, and added a tag to mark synthetic from analytic
...
(wiki) and a corpus of \sme{} news articles. All forms which pass
...
Northern Sámi, but as the results of the fill-in sentence test showed,
