...
also got the MT output, and 3 alternative hand-written \nob{}
paraphrases, and had to choose which paraphrase corresponded to the
\sme{} sentence with the help of the MT.

The second test was set up as the first, but instead of the 3
alternatives, the test presented an open question related to the
translation.
