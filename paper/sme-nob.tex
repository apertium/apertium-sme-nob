...
while most of the \sme{} resources came from N.N.\footnote{See
 \href{http://example.com}{http://example.com}.} \comment{Sámi
  Giellatekno at the University of Tromsø, ref?}, including the
...
We trim the lexicon \comment{more}
...
the use of twol rules which simply forbid analyses containing certain
tags or tag sequences. This twol file is composed onto the main
analyser.\comment{more}
