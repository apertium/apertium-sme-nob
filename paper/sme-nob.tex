...
\section{Evaluation}
\label{sec:eval}
In this section we evaluate the system using several methods. First we
do a word-error rate test, which shows how well the system performs in
a post-editing/dissemination setting, then a set of tests meant to
find out how well the system performs in a gisting/assimilation
setting. All tests were run on revision 37177 of
\texttt{apertium-sme-nob}.
