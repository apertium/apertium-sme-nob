...
\newcommand{\href}[1]{{\tt #1}} % put hyperref in preamble? TODO
...
Constraint Grammar \citep{karlsson1990cgf}\footnote{Using the FOSS
  ...
  \href{http://beta.visl.sdu.dk/cg3.html}}. Morphological
...
\subsection{HFST}
\label{sec:hfst}
One novel feature of apertium-sme-nob is the use of 
\section{Development}
