...
\eenumsentence{\item[a.]{Mun muitt\'{a}n ahte Lillemor Isaksen, geas lei gymn\'{a}sa, measta ii fidnen oahpaheaddjibarggu go son lei s\'{a}megielat. \\ 
...
\item[b.]{Jeg husker at Lillemor Isaksen, som hadde *gymn\'{a}sa, nesten ikke han f{\aa}tt l{\ae}rerarbeidet da han var samisker. \\
...
{}
\shortexnt{7}
{med & en & l{\ae}rer & kom & de & til & undervisning}
{with & a & teacher & came & $they$ & to class}
{}
}
...
like the sentence
%her treng vi shortex -formatet, med gloss og omsetjing:
...
% Also, 'possible' gets Attr by rlx and is thus chunked with 'parents'
