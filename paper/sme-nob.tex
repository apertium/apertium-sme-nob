...
according to the most likely animacy of the agent\footnote{Currently
  ...
  the use of semantic CG sets like HUMAN.}; \sme{} can omit subject
pronouns (\textbf{pro-drop}), when translating to \nob{} we need to
insert either a neuter or masculine/feminine pronoun.
