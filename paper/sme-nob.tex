...
the test for one of the sentences\footnote{English glosses were of
  ...
  saw.}, where the subject could pick one of a., b. or c., b. being
correct.
...
time. Example (\ex{1}) below shows one of the test sentences, with two
word choices had to be made (in this case both key words happened to
translate correctly). All tests were performed using simple HTML
forms.
